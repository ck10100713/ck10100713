...
class MarkdownGenerator
  IMAGE_BASE_URL = 'https://raw.githubusercontent.com/ck10100713/ck10100713/main/images'
  ISSUE_BASE_URL = 'https://github.com/ck10100713/ck10100713/issues/new'
  ...
  def connect4_section(metadata:, recent_moves:)
    ...
    markdown = <<~MARKDOWN
      ![](https://img.shields.io/badge/Moves%20played-#{total_moves_played}-0077B6?style=flat-square)
      ![](https://img.shields.io/badge/Completed%20games-#{completed_games}-023E8A?style=flat-square)
      ![](https://img.shields.io/badge/Total%20players-#{metadata[:all_players].size}-0096C7?style=flat-square)
    ...
    unless game_winning_players.empty?
      markdown.concat <<~MARKDOWN
