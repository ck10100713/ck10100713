...
module Connect4
  class Runner
    ...
    def write_game_state(command:, team:, move:)
      ...
      # Update only the connect4 section in README using markers
      readme_content = File.read(README_PATH)
      connect4_section = generate_connect4_section
      readme_content = readme_content.sub(
        /<!-- BEGIN CONNECT4 -->.*<!-- END CONNECT4 -->/m,
        "<!-- BEGIN CONNECT4 -->\n#{connect4_section}\n<!-- END CONNECT4 -->"
      )
    ...
    def generate_connect4_section
      ...
      MarkdownGenerator.new(game: game).connect4_section(metadata: metadata, recent_moves: recent_moves)
    end
